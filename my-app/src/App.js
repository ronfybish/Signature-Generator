      ...
      <div className="App">
        ...
        <Container>
          <Row>
            ...
            <Col md={6} className="col-left"></Col>
          </Row>
        </Container>
      </div>
    )
