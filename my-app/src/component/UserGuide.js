        ...
        return (
            <div>
                ...
                <Container>
                    ...
                    <ListGroup>
                        <ListGroupItem className="py-3">
                            <h4>1. Login to your Gmail account. <a target="_blank"  href="www.gmail.com">Gmail</a></h4></ListGroupItem>
                        <ListGroupItem >
                            ...
                            <div><img height="150px" src={require('../img/user_guide1.jpg')}/></div>
                            </ListGroupItem>
                        <ListGroupItem  >
                            <h4>3.Click 'Settings' in the drop down menu</h4>
                            <div ><img height="150px"  src={require('../img/user_guide2jpg.jpg')}/></div>
                        </ListGroupItem>
                        <ListGroupItem >
                            ...
                            <div ><img height="150px" width="280px" src={require('../img/user_guide3.png')}/></div>
                            </ListGroupItem>
                        <ListGroupItem>
                            <h4>5. Click on the 'Save changes' at the bottom of the page.</h4>
                            <div ><img height="150px" src={require('../img/user_guide4.jpg')}/></div>
                            </ListGroupItem>
                    </ListGroup>
                </Container>
                <br/>
                ...
                <Container>
                    ...
                    <ListGroup>
                        <ListGroupItem className="py-3">
                            <h4>1. Log in to your Outlook account. <a target="_blank"  href="www.outlook.com">Outlook</a></h4></ListGroupItem>
                        <ListGroupItem >
                            <h4>2. Click on 'File' and then 'Options' in the top left corner of your screen</h4>
                                <div className="mb-3" ><img height="150px" src={require('../img/outlook1.png')}/></div><hr/>
                                <div ><img height="150px" src={require('../img/outlook2.png')}/></div>
                            </ListGroupItem>
                        <ListGroupItem  >
                            <h4>3.Select 'Mail' from the 'Options' menu
                            Click on 'Signatures' and the signature that you like to create or edit</h4>
                            <div ><img height="150px" width="280px" src={require('../img/outlook5s.png')}/></div>
                        </ListGroupItem>
                        <ListGroupItem >
                            <h4 >4. Paste there your new email signature already copied in the clipboard and choose your preferences. </h4>
                            <div ><img  height="150px"  src={require('../img/outlook3.png')}/></div>
                            </ListGroupItem>
                        <ListGroupItem>
                ...
                <Container>
                    ...
                    <ListGroup>
                        <ListGroupItem className="py-3">
                            <h4>1. Log in to your Apple account <a target="_blank" href="https://www.icloud.com/mail">Apple Mail</a></h4></ListGroupItem>
                        <ListGroupItem >
                            <h4>2. In the top left corner of your screen, click 'Mail' and then 'Preferences'</h4>
                                <div ><img height="150px" width="280px" src={require('../img/apple1.png')}/></div>
                            </ListGroupItem>
                        <ListGroupItem  >
                            <h4>3.Select 'Mail' from the 'Options' menu
                            Click on 'Signatures' and the signature that you like to create or edit</h4>
                            <div ><img height="150px" src={require('../img/apple2.gif')}/></div>
                        </ListGroupItem>
                        <ListGroupItem >
                            <h4 >4. Paste there your new email signature already copied in the clipboard and choose your preferences. </h4>
                            <div ><img width="280px" height="150px"  src={require('../img/apple3.jpg')}/></div>
                            </ListGroupItem>
                        <ListGroupItem>
                            <h4>5. then save the changes </h4>
                        </ListGroupItem>
